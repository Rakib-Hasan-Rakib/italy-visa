...
const Info = () => {
  return (
    <>
      <SectionTitle>Italy Visa Information</SectionTitle>
      <Box>
        <p className="tracking-wide">
          Going to Italy with a Job: When we open the pages of the newspaper,
          we see the flashy offer of a Job Visa for going to Italy. It includes
          ...
          there, he/she can’t get an LMO or even go to Italy with a work
          permit. Because, if you try to enter Italy by using fake documents
          and visas, you have to go to jail before arrival in Italy. How it
          works (step by step): 1) The processing will be started with the
          employment agency of Italy as per the agreement with all of your
          ...
          of Italy, your dream won’t materialize. Your time and money will be
          lost in vain and you will be cheated. 2) The employment agency of
          Italy will arrange to produce 4 advertisements in their local
          ...
          file in the VFS- Italy Dhaka office. (a) Passport (b) 2 copies 35×45
